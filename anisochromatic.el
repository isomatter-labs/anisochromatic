...
(def-doom-theme doom-one
  ...
  ((bg         '("#2C313A" nil       nil            ))
   ...
   (base8      '("#FAF4E9" "#FAF4E9" "white"        ))
   (fg         '("#FAF4E9" "#FAF4E9" "brightwhite"  ))
   (fg-alt     '("#FAF4E9" "#FAF4E9" "white"        ))

   (grey       base4)
   (red        '("#E3837A" "#E3837A" "red"          ))
   (orange     '("#E3837A" "#E3837A" "brightred"    ))
   (green      '("#98C379" "#98C379" "green"        ))
   (teal       '("#98C379" "#98C379" "brightgreen"  ))
   (yellow     '("#EEC76D" "#EEC76D" "yellow"       ))
   (blue       '("#62B5F8" "#62B5F8" "brightblue"   ))
   (dark-blue  '("#62B5F8" "#62B5F8" "blue"         ))
   (magenta    '("#AF8DE2" "#AF8DE2" "brightmagenta"))
   (violet     '("#AF8DE2" "#AF8DE2" "magenta"      ))
   (cyan       '("#A4DBF4" "#A4DBF4" "brightcyan"   ))
   (dark-cyan  '("#A4DBF4" "#A4DBF4" "cyan"         ))
